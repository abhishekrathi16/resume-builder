...
const updateEducation = (array: IEducationItem[], id: number, updatedInfo: IEducationItem):IEducationItem[]=>{
...
export const EducationDetailStore = create<IEducationState>((set)=>({
    ...
    setEducation: (newEducationArray:IEducationItem[]) => set((state: IEducationState) => ({
        ...state,
        academics: state.academics = newEducationArray
    })),
    onmoveup: (id: number) => set((state: IEducationState) => ({
        ...state,
        academics: state.academics = [...onMoveUp(state.academics, id)]
    })),
    
    onmovedown: (id: number) => set((state: IEducationState) => ({
        ...state,
        academics: state.academics = onMoveDown(state.academics, id)
    })),
    updateEducation: (id: number, updatedInfo:IEducationItem) => set((state: IEducationState) => ({
        ...state,
        academics: state.academics = updateEducation(state.academics, id, updatedInfo)
    }))
}))
