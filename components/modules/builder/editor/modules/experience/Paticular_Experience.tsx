        ...
        {/* comapny name input */}
          <div className='mt-[20px] mb-[20px]'>
              <TextField
                  ...
                  onChange={(e) => props.updateValue(e.target.value, "company_name", props.id_)}
              />
          </div>
        ...
        {/* position input */}
          <div className='mt-[20px] mb-[20px]'>
              <TextField
                  ...
                  onChange={(e) => props.updateValue(e.target.value, "position", props.id_)}
              />
          </div>
          ...
          <div className='mt-[20px] mb-[20px]'>
              <TextField
                  ...
                  onChange={(e) => props.updateValue(e.target.value, "startDate", props.id_)}
              />
          </div>
          ...
          <div className="flex justify-end items-center">
              ...
              <Switch defaultChecked={checks} onClick={() => props.updateValue(!props.experience.isWorkingHere, "isWorkingHere", props.id_)} /> 
          </div>
          ...
          <div className='mt-[20px] mb-[20px]'>
              <TextField
                  ...
                  placeholder="dd-mm-yyyy"
                  onChange={(e) => props.updateValue(e.target.value, "endDate", props.id_)}
              />
          </div>    
         ...
         {/* Rich Text Editor */}
          <div>
              ...
              name="Description"  
              onChange = {(htmlOutput)=>props.updateValue(htmlOutput, "summary", props.id_)}
            />
          </div>
    </div>
  )
