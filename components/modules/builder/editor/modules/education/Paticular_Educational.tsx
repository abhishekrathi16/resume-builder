    ...
    <div>
        ...
        <div className='mt-[20px] mb-[20px]'>
            <TextField
                ...
                onChange={(e) => props.updateValue(props.id_, e.target.value, "institution")}
            />
        </div>
        ...
        <div className='mt-[20px] mb-[20px]'>
            <TextField
                ...
                onChange={(e) => props.updateValue(props.id_, e.target.value, "degree")}
            />
        </div>
        ...
        <div className='mt-[20px] mb-[20px]'>
            <TextField
                ...
                onChange={(e) => props.updateValue(props.id_, e.target.value, "course")}
            />
        </div>
        ...
        <div className='mt-[20px] mb-[20px]'>
            <TextField
                ...
                onChange={(e) => props.updateValue(props.id_, e.target.value, "startDate")}
            />
        </div>
        ...
        <div className='mt-[20px] mb-[20px]'>
            <TextField
                ...
                placeholder="dd-mm-yyyy"
                onChange={(e) => props.updateValue(props.id_, e.target.value, "endDate")}
            />
        </div>
