    ...
    <div>
      ...
      <div className='mt-[20px] mb-[20px]'>
        <TextField
          ...
          onChange={(e) => props.updateValue (e.target.value, "project_name", props.id_)}
        />
      </div>
      ...
      <div className='mt-[12px] mb-[12px] bg-slate-200 p-[18px] rounded-xl' >
                  ...
                  <>
                    <div className="mt-[4px] mb-[4px] ">
                      <Box style={{ backgroundColor: "#1E40AF ", borderRadius: "16px", padding: '4px' }} >
                        ...
                        < CloseIcon sx={{ color: "white", cursor: "pointer" }} onClick = {()=>props.removeFramework(props.id_, id)}   />
                      </Box>
                    </div>
                  </>
                )
        ...
        <>
          <Box sx={{ display: 'flex', alignItems: 'flex-end' }} >
            ...
            />
            <AddIcon sx={{ color: "#1E40AF", mr: 1, my: 0.5, cursor: "pointer" }} onClick={addFrame } />
          </Box>
        </>
      </div>
